...
public class GameActivity extends AppCompatActivity implements OnGameUpdateCallback, GameView.OnClickListener {
...
//        filter.addAction("de.lmu.ifi.pixelfighter.PROTECTION_WAS_EXECUTED");
    ...
    public void onGameReady(GameSettings gameSettings) {
        ...
        this.gameView.setOnClickListener(GameActivity.this);
        this.gameUpdate.addListeners();
